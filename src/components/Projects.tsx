  ...
  const projects = [
    {
      ...
      description: 'A robust LMS built using the MERN stack featuring user authentication, course management, and real-time communication.',
    ...
    },
    {
      ...
      description: 'Led a group project to predict facial expressions using live camera access and neural networks.',
    ...
    {
      title: 'Checkers Game',
      description: 'Built an interactive Checkers game with a focus on UI/UX design under professional supervision.',
      tech: ['Python', 'UI/UX Design'],
      github: '#',
      demo: '#',
